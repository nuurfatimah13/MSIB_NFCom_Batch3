...
<head>
  ...
  <link rel="stylesheet" href="<?= BASEURL; ?>/css/customstyle.css">
  <!-- Favicons -->
...
<body class="hold-transition login-page gradient-custom">
<div class="login-box">
      ...
      <form action="#" method="post">
        ...
        <div class="row">
          ...
          <div class="col-4">
            ...
            <a href="<?= BASEURL; ?>/dashboard" class="btn btn-primary btn-block">Sign In</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
