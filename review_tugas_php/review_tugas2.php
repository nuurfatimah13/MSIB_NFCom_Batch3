<?php 
  //array scalar agama
  $arr_agama = ['Islam', 'Kristen Katholik', 'Kristen Protestan', 'Hindu', 'Buddha', 'Khonghucu'];
  $arr_jabatan = ['Manager', 'Asisten Manager', 'Kepala Bagian', 'Staff'];
?>
...
<html lang="en">
  ...
  <body>
        ...
        <form id="inputForm" method="post">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" name="agama" aria-label="Agama">
                ...
                <?php foreach ($arr_agama as $agama) { ?>
          ...
          <div class="mb-3">
            ...
            <?php foreach ($arr_jabatan as $jab) { ?>
            <div class="form-check form-check-inline">
              <input class="form-check-input" value="<?= $jab ?>" type="radio" name="jabatan" />
              <label class="form-check-label" for="<?= $jab ?>"><?= $jab ?></label>
            </div>
            <?php } ?>
          </div>
          <div class="mb-3">
    ...
    switch($posisi){
      ...
      case 'Asisten Manager': $gapo = 15000000; break;
      case 'Kepala Bagian': $gapo = 10000000; break;
